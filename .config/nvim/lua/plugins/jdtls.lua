local java_configs = vim.fn.expand("$HOME/.local/share/java")
local jdtls_home = vim.fn.expand("$HOME/.local/share/nvim/mason/packages/jdtls")
local workspace_folder = vim.fn.expand("$HOME") .. "/.local/share/eclipse/" .. vim.fn.fnamemodify(root_dir, ":p:h:t")
return {
  {
      ...
      jdtls = function(_, opts)
        local config = {
          java = {
            format = {
              settings = {
                url = java_configs .. "/java-style.xml",
              },
            },
            completion = {
          ...
          cmd = {
            ...
            "-javaagent:" .. java_configs .. "/lombok-1.18.24.jar",
            "-jar",
